...
export const getUsersTweets=()=> async(dispatch)=>{
  try {
    const {data} = await api.get(`/api/twits/users/${userId}`)
    console.log("get all tweets:",data)
...
export const findTwitsByLikeContainUser=()=> async(dispatch)=>{
  try {
    const {data} = await api.get(`/api/twits/users/${userId}/like`)
    console.log("get all tweets:",data)
...
export const createTweetReply=(tweetData)=> async(dispatch)=>{
  try {
    const {data} = await api.put(`/api/twits/reply`,tweetData)
    console.log("get all tweets:",data)
...
export const createReTweetReply=(twitId)=> async(dispatch)=>{
  try {
...
export const likeTweet=(twitId)=> async(dispatch)=>{
  try {
    const {data} = await api.post(`/api/${twitId}/like`,twitId)
    console.log("get all tweets:",data)
